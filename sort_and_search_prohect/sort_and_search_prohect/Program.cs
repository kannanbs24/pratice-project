        ...
        static void Main(string[] args)
        {
            ...
            switch (ss)
            {
                case 1:
                    ...
                    string textFile = "E:\\c# assignment\\sort_and_search_prohect\\studentdata1.txt";
                    ...
                    // Write to file
                    File.WriteAllLines("E:\\c# assignment\\sort_and_search_prohect\\studentdata2.txt", sorted2.Select(x => x.Key + "," + x.Value).ToArray());
                    ...
                    // Write to file
                    File.WriteAllLines("E:\\c# assignment\\sort_and_search_prohect\\studentdata3.txt", sorted4.Select(x => x.Key + "," + x.Value).ToArray());
                ...
                case 2:
                    ...
                    string[] words = File.ReadAllText("E:\\c# assignment\\sort_and_search_prohect\\studentdata1.txt").Split(' ');
